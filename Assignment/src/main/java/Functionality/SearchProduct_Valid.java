...
public class SearchProduct_Valid {
	@Test
	public void Product_Valid() throws InterruptedException {
	System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "\\Driver\\chromedriver.exe");
			...
			try {
				FileUtils.copyFile(screenshot, new File("C:\\Users\\ADMIN\\eclipse-workspace\\pramod_selenium\\Assignment\\Screenshots\\Search_Valid.png"));
			}catch(IOException e) {
