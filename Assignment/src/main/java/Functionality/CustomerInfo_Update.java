...
public class CustomerInfo_Update {
	@Test
	public void Customer_Info() throws InterruptedException {
	System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "\\Driver\\chromedriver.exe");
			...
			Elements.CustomerInfo.click();
			Elements.Updatelink.click();
			Elements.Edit.click();
			Elements.FullName.clear();
			Elements.FullName.sendKeys("Pramod");
			Elements.SaveBtn.click();
			//Takes Screenshot
			File screenshot =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			//Copy the file to location and use try catch block to handle exception
			try {
				FileUtils.copyFile(screenshot, new File("C:\\Users\\ADMIN\\eclipse-workspace\\pramod_selenium\\Assignment\\Screenshots\\Customer_Info.png"));
			}catch(IOException e) {
