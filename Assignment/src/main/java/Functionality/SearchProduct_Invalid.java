...
public class SearchProduct_Invalid {
	@Test
	public void Product_InValid() throws InterruptedException {
	System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "\\Driver\\chromedriver.exe");
			...
			Elements.SearchBar.sendKeys("Iphone 1");
			...
			try {
				FileUtils.copyFile(screenshot, new File("C:\\Users\\ADMIN\\eclipse-workspace\\pramod_selenium\\Assignment\\Screenshots\\Search_InValid.png"));
			}catch(IOException e) {
